...
def get_links_1(url):
    ...
    other_links_raw = soup.find_all('a', href=re.compile(r'//iling-ran\.ru/web/news/\d{1,}_vpl'))
...
def make_file_2(url):
    ...
    pdf_links_raw = soup.find_all('a', {'target': '_blank'},
                                  href=re.compile(r'//iling-ran\.ru/library/voprosy/\d{1,}\.pdf'))[:30]
...
make_file_2('https://iling-ran.ru/web/ru/publications/journals/vpl')
