...
def write_to_txt(path, text):
    with open(f'/Users/mariabocharova/PycharmProjects/Thesis/texts/Диалог/2020/{path}','w', encoding='utf-8') as file:
        text = text.replace('\n', ' ')
        file.write(text)


# Имена всех существующих файлов в  metadata.csv
def get_names():
...
def dialog_dictionary(url):
    ...
    resource = 'Итоги конференции «Диалог». ' + \
               str(soup.find('h1', {'class': 'page-title-text'}))
