...
# Ссылки на выпуски 2006-2017 гг.
def get_links(url):
    all_links = {}
...
# Создание txt документа и пополнение таблицы
def make_file_1(url, info):
...
for link, info in list(get_links('https://alp.iling.spb.ru/issues.ru.html').items()):
    make_file_1(link, info)


# Парсинг выпусков 2018-2020 гг.
